...
import { Zap, LayoutDashboard, AlertTriangle, FileText, Settings, LogOut, ChevronDown } from "lucide-react"
    ...
    >
      ...
      <div className="p-4 border-t border-border">
        <Button
          ...
          size="sm"
          className={cn(
            "w-full justify-start text-muted-foreground hover:text-foreground transition-all gap-2",
            !isOpen && "justify-center px-2",
          )}
          onClick={() => {
